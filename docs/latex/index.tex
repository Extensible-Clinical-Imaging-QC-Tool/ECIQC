...
This project has made use of the Oxford R\+SE C++ template.\hypertarget{index_autotoc_md1}{}\doxysubsection{Installation}\label{index_autotoc_md1}
\hypertarget{index_autotoc_md2}{}\doxysubsubsection{Where does it run?}\label{index_autotoc_md2}
...
\item Clang 4.\+x, 5.\+x
\end{DoxyItemize}\hypertarget{index_autotoc_md3}{}\doxysubsubsection{First run}\label{index_autotoc_md3}
\hypertarget{index_autotoc_md4}{}\doxyparagraph{Linux}\label{index_autotoc_md4}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md5}{}\doxyparagraph{Mac OS}\label{index_autotoc_md5}
...
\DoxyCodeLine{ctest -\/-\/output-\/on-\/failure}
\end{DoxyCode}
\hypertarget{index_autotoc_md6}{}\doxysubsection{Command Line Interface (\+C\+L\+I) Tool}\label{index_autotoc_md6}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md7}{}\doxysubsection{How to test on your own machine (\+Update 18th May 2023)}\label{index_autotoc_md7}
After you\textquotesingle{}ve cloned the package and installed it properly, we provide two alternatives to test whether it works on your own machine.\hypertarget{index_autotoc_md8}{}\doxysubsubsection{Choice1\+: Using python script to test with the local senders and receivers.}\label{index_autotoc_md8}
