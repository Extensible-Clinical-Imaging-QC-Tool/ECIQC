...
This project has made use of the Oxford RSE C++ template.\hypertarget{index_autotoc_md3}{}\doxysubsection{Installation}\label{index_autotoc_md3}
\hypertarget{index_autotoc_md4}{}\doxysubsubsection{Where does it run?}\label{index_autotoc_md4}
...
\item Clang 4.\+x, 5.\+x
\end{DoxyItemize}\hypertarget{index_autotoc_md5}{}\doxysubsubsection{First run}\label{index_autotoc_md5}
\hypertarget{index_autotoc_md6}{}\doxyparagraph{Linux}\label{index_autotoc_md6}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md7}{}\doxyparagraph{Mac OS}\label{index_autotoc_md7}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md8}{}\doxysubsection{Command Line Interface (\+CLI) Tool}\label{index_autotoc_md8}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md9}{}\doxysubsection{How to test on your own machine (\+Update 18th May 2023)}\label{index_autotoc_md9}
After you\textquotesingle{}ve cloned the package and installed it properly, we provide two alternatives to test whether it works on your own machine.\hypertarget{index_autotoc_md10}{}\doxysubsubsection{Choice1\+: Using python script to test with the local senders and receivers.}\label{index_autotoc_md10}
