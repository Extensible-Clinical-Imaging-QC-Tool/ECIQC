...
This project has made use of the Oxford R\+SE C++ template.\hypertarget{index_autotoc_md3}{}\doxysubsection{Installation}\label{index_autotoc_md3}
...
\DoxyCodeLine{ctest -\/-\/output-\/on-\/failure}
\end{DoxyCode}
\hypertarget{index_autotoc_md8}{}\doxysubsection{Command Line Interface (\+C\+L\+I) Tool}\label{index_autotoc_md8}
