\hypertarget{index_autotoc_md26}{}\doxysubsection{Overview}\label{index_autotoc_md26}
...
This project has made use of the Oxford RSE C++ template.\hypertarget{index_autotoc_md27}{}\doxysubsection{Installation}\label{index_autotoc_md27}
\hypertarget{index_autotoc_md28}{}\doxysubsubsection{Where does it run?}\label{index_autotoc_md28}
...
\item Clang 4.\+x, 5.\+x
\end{DoxyItemize}\hypertarget{index_autotoc_md29}{}\doxysubsubsection{First run}\label{index_autotoc_md29}
\hypertarget{index_autotoc_md30}{}\doxyparagraph{Linux}\label{index_autotoc_md30}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md31}{}\doxyparagraph{Mac OS}\label{index_autotoc_md31}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md32}{}\doxysubsection{Command Line Interface (\+CLI) Tool}\label{index_autotoc_md32}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md33}{}\doxysubsection{How to test on your own machine (\+Update 18th May 2023)}\label{index_autotoc_md33}
After you\textquotesingle{}ve cloned the package and installed it properly, we provide two alternatives to test whether it works on your own machine.\hypertarget{index_autotoc_md34}{}\doxysubsubsection{Choice1\+: Using python script to test with the local senders and receivers.}\label{index_autotoc_md34}
...
Once you\textquotesingle{}ve done all the preparation work, now type in {\ttfamily ./build/exe/qctool -\/-\/config-\/file Your\+Own\+Config.\+json} to start the pipeline. Also remember to start your remote/local sender and receiver.\hypertarget{index_autotoc_md36}{}\doxysubsection{Feedback and suggestions}\label{index_autotoc_md36}
If you have any feedback or suggestions about this project, please get in touch or open an issue.\hypertarget{index_autotoc_md37}{}\doxysubsection{Task sheet for the first week}\label{index_autotoc_md37}
