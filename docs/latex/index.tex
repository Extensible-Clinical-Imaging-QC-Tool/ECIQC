...
This project has made use of the Oxford RSE C++ template.\hypertarget{index_autotoc_md12}{}\doxysubsection{Installation}\label{index_autotoc_md12}
\hypertarget{index_autotoc_md13}{}\doxysubsubsection{Where does it run?}\label{index_autotoc_md13}
...
\item Clang 4.\+x, 5.\+x
\end{DoxyItemize}\hypertarget{index_autotoc_md14}{}\doxysubsubsection{First run}\label{index_autotoc_md14}
\hypertarget{index_autotoc_md15}{}\doxyparagraph{Linux}\label{index_autotoc_md15}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md16}{}\doxyparagraph{Mac OS}\label{index_autotoc_md16}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md17}{}\doxysubsection{Command Line Interface (\+CLI) Tool}\label{index_autotoc_md17}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md18}{}\doxysubsection{How to test on your own machine (\+Update 18th May 2023)}\label{index_autotoc_md18}
After you\textquotesingle{}ve cloned the package and installed it properly, we provide two alternatives to test whether it works on your own machine.\hypertarget{index_autotoc_md19}{}\doxysubsubsection{Choice1\+: Using python script to test with the local senders and receivers.}\label{index_autotoc_md19}
