\href{https://codecov.io/gh/Extensible-Clinical-Imaging-QC-Tool/ECIQC}{\texttt{ }} \href{https://github.com/Extensible-Clinical-Imaging-QC-Tool/ECIQC/actions/workflows/Unittests_Ubuntu.yml}{\texttt{ }} \href{https://github.com/Extensible-Clinical-Imaging-QC-Tool/ECIQC/actions/workflows/Unittests_macOS.yml}{\texttt{ }}\hypertarget{md_doc_pages_tutorial_autotoc_md1}{}\doxysection{Overview}\label{md_doc_pages_tutorial_autotoc_md1}
...
This project has made use of the Oxford R\+SE C++ template.\hypertarget{md_doc_pages_tutorial_autotoc_md2}{}\doxysection{Installation}\label{md_doc_pages_tutorial_autotoc_md2}
\hypertarget{md_doc_pages_tutorial_autotoc_md3}{}\doxysubsection{Where does it run?}\label{md_doc_pages_tutorial_autotoc_md3}
...
\item Clang 4.\+x, 5.\+x
\end{DoxyItemize}\hypertarget{md_doc_pages_tutorial_autotoc_md4}{}\doxysubsection{First run}\label{md_doc_pages_tutorial_autotoc_md4}
\hypertarget{md_doc_pages_tutorial_autotoc_md5}{}\doxysubsubsection{Linux}\label{md_doc_pages_tutorial_autotoc_md5}
...
\end{DoxyCode}
\hypertarget{md_doc_pages_tutorial_autotoc_md6}{}\doxysubsubsection{Mac OS}\label{md_doc_pages_tutorial_autotoc_md6}
...
\DoxyCodeLine{ctest -\/-\/output-\/on-\/failure}
\end{DoxyCode}
\hypertarget{md_doc_pages_tutorial_autotoc_md7}{}\doxysection{Command Line Interface (\+C\+L\+I) Tool}\label{md_doc_pages_tutorial_autotoc_md7}
...
\end{DoxyCode}
\hypertarget{md_doc_pages_tutorial_autotoc_md8}{}\doxysection{How to test on your own machine (\+Update 18th May 2023)}\label{md_doc_pages_tutorial_autotoc_md8}
After you\textquotesingle{}ve cloned the package and installed it properly, we provide two alternatives to test whether it works on your own machine.\hypertarget{md_doc_pages_tutorial_autotoc_md9}{}\doxysubsection{Choice1\+: Using python script to test with the local senders and receivers.}\label{md_doc_pages_tutorial_autotoc_md9}
