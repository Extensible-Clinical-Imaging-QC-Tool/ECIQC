...
int main(int ac, char* av[]) 
{
    ...
    desc.add_options()
        ("help,h", "using --help or -H produces this help message.") // add options to description container using syntax ("tag", "message about flag")
                                                                     // note that these are only descriptions!
    ;
