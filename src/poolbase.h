...
public:
   ...
   */
  class DCMTK_DCMNET_EXPORT DQDBaseSCPWorker : public OFThread
  {
    public:
    ...
    protected:
       ...
       */
      DQDBaseSCPWorker(DQDBaseSCPPool& pool);
...
protected:
   ...
   */
  virtual DQDBaseSCPWorker* createSCPWorker() = 0;
...
private:
  ...
  OFList<DQDBaseSCPWorker*> m_workersBusy;
  /// List of all workers being idle, i.e.\ not running a connection
  OFList<DQDBaseSCPWorker*> m_workersIdle;
 ...
 *    multiple workers.
 */
template<typename SCP = DcmThreadSCP, typename SCPPool = DQDBaseSCPPool, typename BaseSCPWorker = OFTypename SCPPool::DQDBaseSCPWorker>
class DQDSCPPool : public SCPPool
{
public:
